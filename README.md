...
| 版本 | 日期 | 主要更新 |
|------|------|----------|
| 1.7.3 | 2026-08-21 | **修复（1.7.2 严重问题）**：摘星/跳跳/迷宫三款游戏的帧循环刷新订阅此前被误删，导致摘星画面停滞、跳跳/摘星顶部实时分数不随进度刷新；已全部恢复每帧重绘订阅；小熊的家：阳台点击区域下移，使其标签大致落在「小熊的家」标题与「客厅」标签的中线附近，不再贴顶；小熊的家：作息提示文案去重（原「小熊现在在小熊晨练呼啦圈」改为「现在晨练呼啦圈」） |
